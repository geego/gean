...
func TestDefaultOutputFormats(t *testing.T) {
	t.Parallel()
	defs, err := createDefaultOutputFormats(output.DefaultFormats, configurator.New())
...
func TestDefaultOutputFormatsWithOverrides(t *testing.T) {
	...
	defs, err := createDefaultOutputFormats(output.Formats{htmlOut, rssOut}, configurator.New())
