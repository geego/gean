...
func writeRegularPagesForNodeAsPageTests(t *testing.T, fs *geanfs.Fs) {
	writeRegularPagesForNodeAsPageTestsWithLang(t, fs, "")
}

func writeRegularPagesForNodeAsPageTestsWithLang(t *testing.T, fs *geanfs.Fs, lang string) {
	var langStr string
...
func writeNodePagesForNodeAsPageTests(t *testing.T, fs *geanfs.Fs, lang string) {
...
func writeLayoutsForNodeAsPageTests(t *testing.T, fs *geanfs.Fs) {
