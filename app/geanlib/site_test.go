...
func TestRenderWithInvalidTemplate(t *testing.T) {
	...
	errCount := s.Log.LogCountForLevelsGreaterThanorEqualTo(notepad.LevelError)
...
func TestNewSiteDefaultLang(t *testing.T) {
	...
	require.Equal(t, geanfs.Os, s.Fs.Source)
	require.Equal(t, geanfs.Os, s.Fs.Destination)
}
