...
func (t tstEqerType2) Eq(other interface{}) bool {
	return assist.ToString(t) == assist.ToString(other)
}
...
func doTestCompare(t *testing.T, tp tstCompareType, funcUnderTest func(a, b interface{}) bool) {
	for i, test := range []struct {
		...
		{assist.ToTime("2015-11-20"), assist.ToTime("2015-11-20"), 0},
		{assist.ToTime("2015-11-19"), assist.ToTime("2015-11-20"), -1},
		{assist.ToTime("2015-11-20"), assist.ToTime("2015-11-19"), 1},
		{"a", "a", 0},
		{"a", "b", -1},
		{"b", "a", 1},
